(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('escape-string-regexp'), require('@angular/core'), require('@angular/forms'), require('@angular/platform-browser'), require('rxjs/Subject'), require('rxjs/Observable'), require('rxjs/BehaviorSubject'), require('rxjs/add/observable/empty'), require('rxjs/add/observable/from'), require('rxjs/add/observable/of'), require('rxjs/add/operator/distinctUntilChanged'), require('rxjs/add/operator/combineLatest'), require('rxjs/add/operator/mergeMap'), require('rxjs/add/operator/toArray'), require('rxjs/add/operator/filter'), require('rxjs/add/operator/share'), require('rxjs/add/operator/merge'), require('rxjs/add/operator/map'), require('rxjs/add/operator/do'), require('lodash'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', 'escape-string-regexp', '@angular/core', '@angular/forms', '@angular/platform-browser', 'rxjs/Subject', 'rxjs/Observable', 'rxjs/BehaviorSubject', 'rxjs/add/observable/empty', 'rxjs/add/observable/from', 'rxjs/add/observable/of', 'rxjs/add/operator/distinctUntilChanged', 'rxjs/add/operator/combineLatest', 'rxjs/add/operator/mergeMap', 'rxjs/add/operator/toArray', 'rxjs/add/operator/filter', 'rxjs/add/operator/share', 'rxjs/add/operator/merge', 'rxjs/add/operator/map', 'rxjs/add/operator/do', 'lodash', '@angular/common'], factory) :
	(factory((global['ngx-select-ex'] = {}),global.escapeString,global.ng.core,global.ng.forms,global.ng.platformBrowser,global.Rx,global.Rx,global.Rx,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global._,global.ng.common));
}(this, (function (exports,escapeStringNs,core,forms,platformBrowser,Subject,Observable,BehaviorSubject,empty,from,of,distinctUntilChanged,combineLatest,mergeMap,toArray,filter,share,merge,map,_do,lodashNs,common) { 'use strict';
...
var NgxSelectComponent = /** @class */ (function () {
    ...
    function NgxSelectComponent(iterableDiffers, sanitizer, cd, defaultOptions) {
        ...
        this.actualValue = [];
        this.subjOptions = new BehaviorSubject.BehaviorSubject([]);
        this.subjSearchText = new BehaviorSubject.BehaviorSubject('');
        this.subjOptionsSelected = new BehaviorSubject.BehaviorSubject([]);
        this.subjExternalValue = new BehaviorSubject.BehaviorSubject([]);
        this.subjDefaultValue = new BehaviorSubject.BehaviorSubject([]);
        this.subjRegisterOnChange = new Subject.Subject();
        ...
        this.subjOptions
            .flatMap(function (options) { return Observable.Observable
            .from(options)
            .flatMap(function (option) { return option instanceof NgxSelectOption
            ? Observable.Observable.of(option)
            : (option instanceof NgxSelectOptGroup ? Observable.Observable.from(option.options) : Observable.Observable.empty()); })
            .toArray(); })
            .combineLatest(subjActualValue, function (optionsFlat, actualValue) {
            Observable.Observable.from(optionsFlat)
    ...
    NgxSelectComponent.prototype.optionsFilteredFlat = function () {
        ...
        if (this.cacheOptionsFilteredFlat) {
            return Observable.Observable.of(this.cacheOptionsFilteredFlat);
        }
        return Observable.Observable.from(this.optionsFiltered)
            .flatMap(function (option) { return option instanceof NgxSelectOption ? Observable.Observable.of(option) :
            (option instanceof NgxSelectOptGroup ? Observable.Observable.from(option.optionsFiltered) : Observable.Observable.empty()); })
