...
export declare class NgxSelectComponent implements INgxSelectOptions, ControlValueAccessor, DoCheck, AfterContentChecked {
    ...
    protected inputKeyUp(value?: string): void;
    protected doInputText(value: string): void;
    protected inputClick(value?: string): void;
    protected sanitize(html: string): SafeHtml;
    protected highlightOption(option: NgxSelectOption): SafeHtml;
    protected optionSelect(option: NgxSelectOption, event?: Event): void;
    protected optionRemove(option: NgxSelectOption, event: Event): void;
    protected isOptionActive(option: NgxSelectOption, element: HTMLElement): boolean;
    ...
    optionsClose(focusToHost?: boolean): void;
