...
@Component({
  selector: "app-eventosdesistema",
  templateUrl: "./eventosdesistema.component.html",
  styleUrls: ["./eventosdesistema.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class EventosdesistemaComponent implements OnInit {
  //NGXDATATABLE
  editing = {};
  rows = [];
  rowsFilter = [];
